      ...
      >
        ...
        <Grid item style={{ backgroundColor: '' }}>
          ...
          <section id='sendum' style={{ paddingTop: 20 }}>
            ...
            {/* What is the BLE app? */}
            <p>
              At Sendum Wireless, I was tasked to develop a mobile application
              to communicate with peripheral Bluetooth Low Energy(BLE) devices
              in order for the app to read and display data from a monitoring
              device.
            </p>
            {/* tech used for BLE app */}
            <p>
              I worked independantly to build the app with Angular with
              Typescript and Ionic mobile toolkit for UI design.
            </p>
            {/* what I specifically did for BLE app */}
            <p>
              I developed core functionality of connecting to a device via
              QRscan, parsing advertising BLE packets encoding live-data
              readings in bytes, reading/writing bytes commands to access API
              for accessing logged data, and generating user friendly screens to
              allow user to notified of state of the app during the bluetooth
              connection showing the state of BLE connection{' '}
            </p>
          </section>
          ...
          <section style={{ paddingTop: 20 }}>
            ...
            <p>
              ...
              toolkit for the styling. For the backend, we used AWS Amplify CLI
              as a simple way to generate user authentication, GraphQL API, and
              database for the app. We could log into AWS to generate users via
              Cognito and generate endpoints using the web interface.
            </p>
            <p>
              {/* what I specifically did for driver app */}I helped design the
              UI displaying a simple and intuitive list of milestones with
              buttons for drivers interact with, and generate backend
              infrastructure with AWS Amplify CLI.
            </p>
          </section>
          <List
            sx={{
        ...
        <Grid item>
          ...
          >
            ...
            >
              ...
              <p>
                {/* What is Diabits */}
                At Bio Conscious Technologies, I worked on creating a cross
                platform version of the native iOS app, Diabits. This app was
                used to help users with Diabetes to better manage blood glucose
                fluctuations by seeing predicted future glucose values.
              </p>
              {/* tech used */}
              <p>
